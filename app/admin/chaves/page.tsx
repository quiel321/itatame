    ...
    <main className="bg-[#050505] text-white p-4 pt-12 pb-12 md:pt-20 md:min-h-screen relative overflow-x-hidden">
      ...
      <div className="w-full max-w-xl mx-auto relative z-10">
        ...
        <div className="flex items-center gap-3 mb-6">
          <button onClick={() => router.push("/admin")} className="cursor-pointer p-2.5 bg-white/5 hover:bg-white/10 rounded-lg transition-colors text-zinc-400 hover:text-white border border-white/5 shrink-0">
