    ...
    <FotosShell>
      <main className="min-h-screen overflow-x-hidden bg-[#050505] text-white">
        <section className="relative overflow-hidden border-b border-white/5 px-4 py-20 md:px-6 md:py-28">
          <div className="pointer-events-none absolute left-1/2 top-0 h-[500px] w-[900px] -translate-x-1/2 rounded-full bg-retratt/10 blur-[140px]" />
          <div className="relative mx-auto max-w-5xl text-center">
            <span className="inline-flex items-center gap-2 rounded-full border border-retratt/20 bg-retratt/10 px-4 py-2 text-[9px] font-black uppercase tracking-[0.24em] text-retratt">
        ...
        <section id="fotografo" className="px-4 py-16 md:px-6 md:py-24">
          <div className="mx-auto grid max-w-7xl gap-6 lg:grid-cols-[1.05fr_0.95fr]">
            <article className="rounded-3xl border border-retratt/20 bg-retratt/[0.04] p-6 md:p-9">
              <div className="flex items-start justify-between gap-4">
                <div>
                  <span className="text-[9px] font-black uppercase tracking-[0.22em] text-retratt">Fotógrafo freelancer</span>
        ...
        <section id="organizador" className="border-y border-white/5 bg-[#0a0a0e] px-4 py-16 md:px-6 md:py-24">
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-10 grid gap-5 lg:grid-cols-2">
              <article className="rounded-3xl border border-retratt/20 bg-retratt/[0.04] p-6 md:p-8">
        ...
        <section className="px-4 py-16 md:px-6 md:py-24">
          <div className="mx-auto max-w-7xl">
            <div className="max-w-3xl">
              <span className="text-[9px] font-black uppercase tracking-[0.22em] text-retratt">Infraestrutura de ponta</span>
            ...
            <div className="mt-10 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              {tecnologia.map(({ icon: Icon, titulo, texto }) => (
                <article key={titulo} className="rounded-2xl border border-white/5 bg-[#0a0a0e] p-5 transition-colors hover:border-retratt/25 md:p-7">
                  <div className="flex h-11 w-11 items-center justify-center rounded-xl border border-retratt/20 bg-retratt/10 text-retratt"><Icon size={20} /></div>
        ...
        <section className="px-4 py-16 md:px-6 md:py-24">
          <div className="mx-auto max-w-4xl">
            <div className="text-center"><HelpCircle className="mx-auto text-retratt" size={28} /><h2 className="mt-4 text-2xl font-black uppercase md:text-4xl">Perguntas frequentes</h2></div>
            <div className="mt-9 space-y-3">
              {perguntas.map(({ pergunta, resposta }) => (
                <details key={pergunta} className="group rounded-2xl border border-white/5 bg-[#0a0a0e] p-5 open:border-retratt/20">
        ...
        <section className="border-t border-white/5 bg-gradient-to-t from-orange-950/20 to-[#050505] px-4 py-20 text-center md:py-28">
          <Sparkles className="mx-auto text-retratt" size={30} />
          ...
          <p className="mx-auto mt-4 max-w-xl text-xs font-medium leading-relaxed text-zinc-400 md:text-sm">Abra sua primeira galeria sem mensalidade ou conecte a operação oficial do seu evento.</p>
          <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
            <Link href="/fotos/fotografo" className="inline-flex h-12 items-center justify-center gap-2 rounded-xl bg-retratt px-7 text-[10px] font-black uppercase tracking-widest text-black hover:bg-retratt">Para fotógrafos <ArrowRight size={15} /></Link>
            <Link href="/fotos/organizador" className="inline-flex h-12 items-center justify-center gap-2 rounded-xl bg-retratt px-7 text-[10px] font-black uppercase tracking-widest text-black hover:bg-retratt">Para organizadores <ArrowRight size={15} /></Link>
          </div>
        </section>
      </main>
    </FotosShell>
