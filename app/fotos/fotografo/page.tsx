...
const funcionalidadesDashboard = [
  ...
  },
  {
    ...
    texto: "Conecte sua conta de recebimento. Quando o cliente paga, o sistema separa a taxa da Retratt e direciona automaticamente a sua parte para a sua conta.",
    icon: CreditCard
  },
];
...
const comparativo = [
  {
    ...
    itens: ["Links perdidos em conversas", "Cobrança manual e desgastante", "Risco de prints não pagos", "Processo lento para o cliente"],
    destaque: false,
  },
  {
  ...
  return (
    <FotosShell>
      <main className="min-h-screen bg-[#050505] text-white font-sans selection:bg-retratt/30 overflow-x-hidden w-full">
          ...
          <div className="relative z-30 w-full max-w-7xl mx-auto px-4 md:px-8">
            ...
            <div className="max-w-xl text-left -mt-8 md:-mt-16">
              ...
              <span className="inline-flex items-center gap-1.5 bg-retratt/10 border border-retratt/20 text-retratt px-3 py-1 rounded-full text-[8px] md:text-[9px] font-black uppercase tracking-[0.2em] mb-4 md:mb-5 shadow-[0_0_20px_rgba(255,90,31,0.15)]">
                <Camera size={12} /> Fotografia de Eventos
              </span>
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[54px] font-black uppercase tracking-tighter leading-[1.1] md:leading-[1.05] drop-shadow-2xl mb-4 md:mb-5">
                ...
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-retratt to-orange-700">Deixe as vendas no automático.</span>
              </h1>
        ...
        {/* Como funciona a operação do fotógrafo */}
        <section id="funcionalidades" className="relative z-20 max-w-7xl mx-auto px-4 md:px-6 py-16 md:py-28">
          <div className="text-center mb-10 md:mb-16">
             <span className="text-retratt text-[9px] md:text-[10px] font-black uppercase tracking-[0.2em] mb-2 block">O seu novo espaço de trabalho</span>
            ...
            <div className="grid md:grid-cols-3 gap-4 md:gap-6">
              {comparativo.map((card) => (
                <div key={card.titulo} className={`rounded-2xl md:rounded-3xl border p-5 md:p-8 flex flex-col ${card.destaque ? "border-retratt/50 bg-retratt/10 shadow-[0_20px_50px_rgba(255,90,31,0.15)] transform md:-translate-y-4 relative" : "border-white/5 bg-[#111] opacity-70 hover:opacity-100 transition-opacity"}`}>
                  ...
                  {card.destaque && (
                     <Link href="/fotos/cadastro?perfil=fotografo" className="mt-auto w-full py-3.5 md:py-4 rounded-xl bg-retratt hover:bg-retratt text-black text-[9px] md:text-[10px] font-black uppercase tracking-widest text-center transition-colors shadow-[0_0_15px_rgba(255,90,31,0.2)]">
                        Quero vender assim
                     </Link>
                  )}
                </div>
        ...
        <section className="py-16 md:py-28 px-4 md:px-6 w-full overflow-hidden">
          <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-10 md:gap-20">
            <div className="flex-1 relative w-full">
               <div className="absolute inset-0 bg-retratt/10 blur-[60px] md:blur-[100px] rounded-full"></div>
               <div className="relative bg-[#111] border border-white/10 rounded-2xl md:rounded-3xl p-5 sm:p-8 overflow-hidden shadow-2xl">
                  ...
                  <div className="space-y-3 md:space-y-4">
                     ...
                     <div className="bg-retratt/10 border border-retratt/20 p-3.5 md:p-4 rounded-xl md:rounded-2xl flex flex-row justify-between items-center gap-2">
                        <span className="text-[8px] md:text-[10px] text-retratt font-bold uppercase tracking-wider">Lucro do Evento (Royalty)</span>
                        <span className="text-base md:text-lg font-black text-retratt">R$ 5.175,00</span>
                     </div>
                  </div>
               </div>
            </div>
        ...
        <section className="py-16 md:py-32 px-4 text-center border-t border-white/5 bg-gradient-to-t from-[#0a0a0e] to-[#050505]">
          <ImagePlus size={32} className="mx-auto text-retratt mb-4 md:mb-6 opacity-80 md:w-10 md:h-10" />
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3 md:gap-4">
             <Link href="/fotos/cadastro?perfil=fotografo" className="inline-flex items-center justify-center bg-retratt text-black px-8 py-3.5 md:px-10 md:py-4 rounded-xl text-[10px] md:text-[11px] font-black uppercase tracking-widest transition-transform hover:scale-105 shadow-[0_0_30px_rgba(255,90,31,0.3)]">
               Criar meu Perfil
             </Link>
          </div>
        </section>
