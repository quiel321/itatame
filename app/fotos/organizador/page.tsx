...
const comparativo = [
  {
    ...
    itens: ["Público não encontra a sua imagem", "Organizador não fatura nada", "Fotógrafo perde vendas", "Zero profissionalismo no pós-evento"],
    destaque: false,
  },
  {
...
const passos = [
  ...
  { titulo: "Convide Fotógrafos", texto: "Credencie profissionais da sua confiança para cobrirem as áreas do evento.", icon: Camera },
  { titulo: "Venda Inteligente", texto: "Cada pessoa encontra as próprias fotos em segundos usando reconhecimento facial inteligente.", icon: Zap },
...
export default function FotosOrganizadorPage() {
  return (
    <FotosShell>
      <main className="min-h-screen bg-[#050505] text-white font-sans selection:bg-retratt/30 overflow-x-hidden w-full">
        ...
        <section className="relative w-full min-h-[85vh] flex items-center pt-20 pb-12 md:pt-24 md:pb-16 overflow-hidden border-b border-white/5 bg-black">
          ...
          <div className="absolute inset-0 z-0 pointer-events-none">
            ...
            <div className="absolute top-1/2 left-0 -translate-y-1/2 w-[300px] md:w-[600px] h-[300px] md:h-[600px] bg-retratt/15 blur-[100px] md:blur-[150px] rounded-full z-10"></div>
          </div>
          ...
          <div className="relative z-30 w-full max-w-7xl mx-auto px-4 md:px-8">
            ...
            <div className="max-w-xl text-left -mt-8 md:-mt-16">
              ...
              <span className="inline-flex items-center gap-1.5 bg-retratt/10 border border-retratt/20 text-retratt px-3 py-1 rounded-full text-[8px] md:text-[9px] font-black uppercase tracking-[0.2em] mb-4 md:mb-5 shadow-[0_0_20px_rgba(255,90,31,0.15)]">
                <Trophy size={12} /> Para Organizadores de Eventos
              </span>
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[54px] font-black uppercase tracking-tighter leading-[1.1] md:leading-[1.05] drop-shadow-2xl mb-4 md:mb-5">
                ...
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-retratt to-retratt">Transforme isso em lucro.</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-3 md:gap-4 w-full sm:w-auto mb-8 md:mb-10">
                <Link href="/fotos/login?perfil=organizador&next=/fotos/admin" className="flex items-center justify-center gap-2 bg-retratt hover:bg-retratt text-black px-6 py-3.5 md:px-7 md:py-3.5 rounded-xl text-[9px] md:text-[11px] font-black uppercase tracking-widest transition-all shadow-[0_0_30px_rgba(255,90,31,0.3)] hover:scale-105">
        ...
        {/* Como funciona a operação do organizador */}
        <section id="como-funciona" className="relative z-20 max-w-7xl mx-auto px-4 md:px-6 py-16 md:py-28">
          <div className="text-center mb-10 md:mb-16">
             <span className="text-retratt text-[9px] md:text-[10px] font-black uppercase tracking-[0.2em] mb-2 block">Operação Inteligente</span>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            {passos.map(({ titulo, texto, icon: Icon }, index) => (
              <div key={titulo} className="bg-[#0a0a0e] border border-white/5 p-5 md:p-8 rounded-2xl md:rounded-3xl hover:border-retratt/30 hover:bg-retratt/5 transition-all duration-300 relative group overflow-hidden">
                <div className="absolute top-0 right-0 w-24 md:w-32 h-24 md:h-32 bg-retratt/5 blur-3xl rounded-full transition-all group-hover:bg-retratt/15"></div>

                <div className="flex items-center justify-between mb-4 md:mb-6 relative z-10">
                  <div className="w-10 h-10 md:w-12 md:h-12 shrink-0 bg-retratt/10 rounded-xl flex items-center justify-center text-retratt border border-retratt/20">
        ...
        <section className="py-16 md:py-28 px-4 md:px-6 border-y border-white/5 bg-[#0a0a0e] relative overflow-hidden w-full">
          <div className="absolute top-1/2 left-0 w-full h-[1px] bg-gradient-to-r from-transparent via-retratt/20 to-transparent"></div>
          <div className="absolute inset-0 bg-retratt/5 blur-[120px] pointer-events-none"></div>

          <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-10 md:gap-20 relative z-10">

            <div className="flex-1 text-center md:text-left order-2 md:order-1">
              <span className="inline-flex items-center gap-1.5 text-retratt font-black text-[8px] md:text-[9px] uppercase tracking-[0.2em] mb-3 md:mb-4">
                Transparência Total
              </span>
              ...
              <ul className="space-y-3 md:space-y-4 mb-8 text-left max-w-md mx-auto md:mx-0 px-2 md:px-0">
                  <li className="flex items-center gap-3">
                    <CheckCircle2 size={16} className="text-retratt shrink-0" />
                    <span className="text-zinc-300 text-[10px] md:text-[11px] font-bold uppercase tracking-wide">Visão global de vendas do evento</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <CheckCircle2 size={16} className="text-retratt shrink-0" />
              ...
              <Link href="/fotos/login?perfil=organizador&next=/fotos/admin" className="inline-flex w-full sm:w-auto justify-center bg-retratt hover:bg-retratt text-black px-8 py-3.5 md:py-4 rounded-xl text-[10px] font-black uppercase tracking-widest transition-colors shadow-[0_0_20px_rgba(255,90,31,0.2)]">
                Acessar Dashboard
              </Link>
            </div>
            ...
            <div className="flex-1 relative w-full order-1 md:order-2">
               <div className="absolute inset-0 bg-gradient-to-tr from-retratt/20 to-retratt/10 blur-3xl rounded-full"></div>
               <div className="relative bg-[#111] border border-white/10 rounded-2xl md:rounded-3xl p-5 md:p-8 shadow-2xl overflow-hidden">
                  ...
                  <div className="flex items-center justify-between border-b border-white/5 pb-4 mb-5 md:mb-6">
                    <div className="flex gap-1.5 md:gap-2">
                      <div className="w-2.5 h-2.5 md:w-3 md:h-3 rounded-full bg-retratt/50"></div>
                  ...
                  <div className="grid grid-cols-2 gap-3 md:gap-4 mb-5 md:mb-6">
                    ...
                    <div className="bg-retratt/10 rounded-xl md:rounded-2xl p-3 md:p-4 border border-retratt/30 shadow-[0_0_15px_rgba(255,90,31,0.1)] flex flex-col justify-center">
                      <p className="text-[8px] md:text-[9px] text-retratt font-bold uppercase tracking-wider mb-1 truncate">Royalties Livres</p>
                      <p className="text-xl md:text-2xl font-black text-retratt">R$ 8.560</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2 md:space-y-3">
                    ...
                    {[
                       { nome: 'João Silva (Pista A)', vendas: 1240 },
                       { nome: 'Maria Souza (Pódio)', vendas: 890 },
                       { nome: 'Pedro Álvares (Palco B)', vendas: 650 }
                    ].map((fotografo, i) => (
                      <div key={i} className="flex items-center justify-between bg-black/60 p-2.5 md:p-3 rounded-xl border border-white/5">
                        <div className="flex items-center gap-2.5 md:gap-3 min-w-0">
                          <div className={`w-7 h-7 md:w-8 md:h-8 shrink-0 rounded-full flex items-center justify-center text-[9px] md:text-[10px] font-black ${i === 0 ? 'bg-retratt/20 text-retratt border border-retratt/30' : 'bg-zinc-900 text-zinc-500 border border-white/5'}`}>
                              {i + 1}º
                          </div>
        ...
        <section className="py-16 md:py-28 relative overflow-hidden w-full">
           <div className="max-w-6xl mx-auto px-4 md:px-6 relative z-10">
            <div className="text-center mb-10 md:mb-16">
              ...
              <p className="text-zinc-400 text-[11px] md:text-sm max-w-lg mx-auto font-medium px-2">As fotos do seu evento deixam de depender de grupos de WhatsApp, links soltos e conversas perdidas.</p>
            </div>

            <div className="grid md:grid-cols-3 gap-4 md:gap-6">
              {comparativo.map((card) => (
                <div key={card.titulo} className={`rounded-2xl md:rounded-3xl border p-5 md:p-8 flex flex-col ${card.destaque ? "border-retratt/50 bg-retratt/10 shadow-[0_20px_50px_rgba(255,90,31,0.15)] transform md:-translate-y-4 relative" : "border-white/5 bg-[#111] opacity-70 hover:opacity-100 transition-opacity"}`}>

                  {card.destaque && (
                     <div className="mb-5 md:mb-6 flex">
                        <span className="inline-flex items-center gap-1.5 bg-retratt text-black px-3 py-1 rounded text-[8px] md:text-[9px] font-black uppercase tracking-widest shadow-md">
                  ...
                  <div className="space-y-3 md:space-y-4 mb-6 md:mb-8 flex-1">
                    {card.itens.map((item) => (
                      <p key={item} className="flex items-start gap-2.5 md:gap-3 text-[11px] md:text-xs leading-relaxed text-zinc-300 font-medium">
                        <CheckCircle2 size={14} className={`shrink-0 mt-0.5 md:w-4 md:h-4 ${card.destaque ? "text-retratt" : "text-zinc-600"}`} /> {item}
                      </p>
                    ))}
                  </div>
                </div>
        ...
        <section className="py-16 md:py-32 px-4 text-center border-t border-white/5 bg-gradient-to-t from-[#0a0a0e] to-[#050505]">
          <ShieldCheck size={32} className="mx-auto text-retratt mb-4 md:mb-6 opacity-80 md:w-10 md:h-10" />
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3 md:gap-4">
             <Link href="/fotos/login?perfil=organizador&next=/fotos/admin" className="inline-flex items-center justify-center bg-retratt text-black px-8 py-3.5 md:px-10 md:py-4 rounded-xl text-[10px] md:text-[11px] font-black uppercase tracking-widest transition-transform hover:scale-105 shadow-[0_0_30px_rgba(255,90,31,0.3)] w-full sm:w-auto">
               Criar Galeria do Evento
             </Link>
          </div>
        </section>
