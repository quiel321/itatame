    ...
    <>
      ...
      <header className="fixed top-0 left-0 right-0 z-50 border-b border-white/5 bg-[#0a0a0a]/90 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-2.5 flex items-center justify-between">
          ...
          {/* LOGO OFICIAL - Ajustado para não quebrar o layout no mobile */}
          <Link href="/" className="flex items-center hover:opacity-90 transition-opacity shrink-0">
            <img 
              src="/logo.svg" 
              alt="iTatame - Sistema de Campeonatos" 
              className="h-7 md:h-10 w-[120px] md:w-[200px] object-contain" 
            />
          </Link>
          ...
          {/* NAVEGAÇÃO MOBILE (Botão Criar Evento + Perfil) */}
