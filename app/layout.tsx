      ...
      <body className="min-h-full flex flex-col bg-[#050505] text-white">
        ...
        <footer className="bg-[#050505] border-t border-white/5 relative overflow-hidden pt-12 pb-24 md:pb-6 mt-16 shadow-[0_-10px_30px_rgba(0,0,0,0.3)]">
          ...
          <div className="max-w-7xl mx-auto px-6 relative z-10">
            ...
            {/* GRID DE COLUNAS COM ESPAÇAMENTOS MENORES (gap-8 e mb-10) */}
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-10 mb-10">
              ...
              <div className="flex flex-col gap-4 lg:pr-6">
                ...
                {/* Ícones de redes sociais removidos conforme solicitado */}
              </div>
              ...
              {/* Box mais enxuto (p-5 em vez de p-6) */}
              <div className="bg-[#0a0a0e]/60 border border-white/5 p-5 rounded-2xl shadow-[0_0_30px_rgba(0,0,0,0.5)]">
                ...
                <div className="flex flex-col gap-2.5">
                  <a href="https://wa.me/5565993059729" target="_blank" className="flex items-center justify-center gap-2 w-full bg-[#25D366]/10 hover:bg-[#25D366]/20 border border-[#25D366]/30 text-[#25D366] py-2 rounded-lg text-[10px] font-black uppercase tracking-widest transition-all shadow-sm">
                ...
                {/* BARRA INFERIOR COM PADDING REDUZIDO (pt-5) */}
                <div className="border-t border-white/5 pt-5 flex flex-col md:flex-row items-center justify-between gap-4">
                  <div className="flex items-center gap-3">
                    <span className="w-6 h-6 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white text-[12px] font-black shadow-inner italic">
