                ...
                <form onSubmit={handleCadastro} className="space-y-3.5 animate-in fade-in h-[60vh] md:h-auto overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-white/10">
                  ...
                  <div>
                    ...
                    <div className="relative cursor-text">
                      ...
                      <input type="tel" required value={telefone} onChange={(e) => setTelefone(formatarTelefone(e.target.value))} placeholder="(00) 00000-0000" className="w-full bg-[#050505] border border-white/10 rounded-lg pl-10 pr-3 py-2.5 outline-none focus:border-yellow-600 text-white transition-colors text-xs font-bold placeholder:text-zinc-700 shadow-inner" />
                    </div>
                  </div>
