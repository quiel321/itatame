...
create or replace trigger proteger_categoria_utilizada before update or delete on public.categorias_evento for each row execute function public.proteger_categoria_utilizada();
